...
CREATE TABLE `mall_category`  (
  ...
  `sort_order` int NOT NULL DEFAULT 1 COMMENT '数值越大，优先级越高',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100041 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of mall_category
-- ----------------------------
INSERT INTO `mall_category` VALUES (100001, 0, '家用电器', 1, 2, '2000-03-25 16:46:00', '2000-03-25 16:46:00');
...
-- ----------------------------
INSERT INTO `mall_order` VALUES (1, 1665838893002, 1, 1, 27996.00, 1, 0, 10, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `mall_order` VALUES (2, 1665839015816, 1, 1, 0.01, 1, 0, 20, '2022-10-16 00:08:57', NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `mall_order_item` VALUES (1, 1, 1665838893002, 26, 'Apple iPhone 7 Plus (A1661) 128G 玫瑰金色 移动联通电信4G手机', 'http://img.springboot.cn/241997c4-9e62-4824-b7f0-7425c3c28917.jpeg', 6999.00, 4, 27996.00, NULL, NULL);
INSERT INTO `mall_order_item` VALUES (2, 1, 1665839015816, 26, 'Apple iPhone 7 Plus (A1661) 128G 玫瑰金色 移动联通电信4G手机', 'http://img.springboot.cn/241997c4-9e62-4824-b7f0-7425c3c28917.jpeg', 6999.00, 1, 6999.00, NULL, NULL);
...
-- ----------------------------
INSERT INTO `mall_pay_info` VALUES (1, NULL, 2312, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 08:44:17', '2022-10-10 08:44:17');
INSERT INTO `mall_pay_info` VALUES (19, NULL, 2320, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 09:43:50', '2022-10-10 09:43:50');
INSERT INTO `mall_pay_info` VALUES (20, NULL, 2321, 2, '4200001542202210104006599170', 'SUCCESS', 0.01, '2022-10-10 09:44:00', '2022-10-10 09:44:26');
INSERT INTO `mall_pay_info` VALUES (21, NULL, 2316, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:31:29', '2022-10-10 11:31:29');
INSERT INTO `mall_pay_info` VALUES (23, NULL, 2322, 2, '4200001552202210104925388894', 'SUCCESS', 0.01, '2022-10-10 11:32:07', '2022-10-10 11:32:25');
INSERT INTO `mall_pay_info` VALUES (24, NULL, 2323, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:34:11', '2022-10-10 11:34:11');
INSERT INTO `mall_pay_info` VALUES (25, NULL, 2324, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:34:29', '2022-10-10 11:34:29');
INSERT INTO `mall_pay_info` VALUES (32, NULL, 2325, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:36:05', '2022-10-10 11:36:05');
INSERT INTO `mall_pay_info` VALUES (33, NULL, 2326, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:38:30', '2022-10-10 11:38:30');
INSERT INTO `mall_pay_info` VALUES (35, NULL, 2327, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:38:52', '2022-10-10 11:38:52');
INSERT INTO `mall_pay_info` VALUES (37, NULL, 2328, 2, '4200001565202210104296165586', 'SUCCESS', 0.01, '2022-10-10 11:39:10', '2022-10-10 11:39:35');
INSERT INTO `mall_pay_info` VALUES (40, NULL, 2329, 2, '4200001585202210108134199354', 'SUCCESS', 0.01, '2022-10-10 11:43:39', '2022-10-10 11:44:08');
INSERT INTO `mall_pay_info` VALUES (42, NULL, 2330, 2, '4200001583202210107380591949', 'SUCCESS', 0.01, '2022-10-10 11:46:36', '2022-10-10 11:47:00');
INSERT INTO `mall_pay_info` VALUES (49, NULL, 2331, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:59:01', '2022-10-10 11:59:01');
INSERT INTO `mall_pay_info` VALUES (50, NULL, 2332, 2, NULL, 'NOTPAY', 0.01, '2022-10-10 11:59:33', '2022-10-10 11:59:33');
INSERT INTO `mall_pay_info` VALUES (51, NULL, 1665839015816, 2, '4200001553202210167042335040', 'SUCCESS', 0.01, '2022-10-16 00:04:33', '2022-10-16 00:05:30');

-- ----------------------------
-- Table structure for mall_pay_info_copy1
-- ----------------------------
DROP TABLE IF EXISTS `mall_pay_info_copy1`;
CREATE TABLE `mall_pay_info_copy1`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `order_no` bigint NOT NULL COMMENT '订单号',
  `pay_platform` int NULL DEFAULT NULL COMMENT '支付平台:1-支付宝,2-微信',
...
-- ----------------------------
-- Records of mall_pay_info_copy1
-- ----------------------------
...
-- ----------------------------
INSERT INTO `mall_shipping` VALUES (1, 1, '刘金磊', '15941819999', '9999', '辽宁省', '阜新市', '阜新蒙古族自治县', '1', '123100', '2022-10-13 23:59:26', '2022-10-15 20:59:44');
...
INSERT INTO `mall_shipping` VALUES (7, 1, '刘金磊', '15941819999', '9999', '辽宁省', '阜新市', '阜新蒙古族自治县', '1', '123100', '2022-10-14 00:01:41', '2022-10-14 00:01:41');
...
INSERT INTO `mall_user` VALUES (6, 'admin1', '4684a0c98c995b93330b400b665918ce', 'ena@163.com', NULL, NULL, NULL, 1, '2022-10-10 20:33:47', '2022-10-10 20:33:47');
INSERT INTO `mall_user` VALUES (7, 'admin2', '8a3cd92bd64d96c3fb78a73fb8d4d0c9', 'ena@167.com', NULL, NULL, NULL, 1, '2022-10-10 20:34:52', '2022-10-10 20:34:52');
INSERT INTO `mall_user` VALUES (8, 'admin3', '8a3cd92bd64d96c3fb78a73fb8d4d0c9', 'ena@168.com', NULL, NULL, NULL, 1, '2022-10-10 20:35:08', '2022-10-10 20:35:08');
INSERT INTO `mall_user` VALUES (9, 'admin4', '8a3cd92bd64d96c3fb78a73fb8d4d0c9', 'enaa@168.com', NULL, NULL, NULL, 1, '2022-10-10 21:25:10', '2022-10-10 21:25:10');
INSERT INTO `mall_user` VALUES (13, 'jack', 'f88b30636b2b628adef2bb8a22546ce0', 'jack@qq.com', NULL, NULL, NULL, 1, '2022-10-11 20:33:46', '2022-10-11 20:33:46');
